-- ============================================================
-- Migration 022 - Seed demo com perfis variados e sérios
-- Jon Snow: QA Engineer, Backend Dev, Frontend Dev, Dev Pleno, QA EN
-- Easter eggs: Stark Ventures · Arya Stark · QA Lead (token);
--              "You know nothing, Jon Snow" (observação candidatura)
-- ============================================================
